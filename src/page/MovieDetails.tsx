    ...
    `,
      ...
      >
        <div className="hero-overlay grid lg:grid-cols-20 md:grid-cols-12">
          ...
          <div
            className="lg:col-span-11 md:col-span-4">
            <h1
              style={{
                fontSize: "2.5em",
                marginBottom: "24px",
            ...
            <div>
              {movie.like_count !== undefined && movie.like_count !== null && <><span className="text-xl"><ThumbUpIcon sx={{ color: "#49c916", marginRight: 2 }} /></span>{movie.like_count}</>}
